...
var ReactPlayer = function (_Component) {
  ...
  _createClass(ReactPlayer, [{
    ...
    value: function getActivePlayer(url) {
      var disabledPlayers = this.props.disabledPlayers;

      var filteredPlayers = _players2['default'].filter(function (p) {
        return !disabledPlayers.includes(p.displayName);
      });

      var _arr = [].concat(_toConsumableArray(customPlayers), _toConsumableArray(filteredPlayers));
